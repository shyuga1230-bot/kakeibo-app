  ...
  return (
    <form action={formAction} onKeyDown={blockEnterSubmit} className="space-y-4">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-md bg-blue-600 px-4 py-3 text-base font-medium text-white hover:bg-blue-700 disabled:opacity-50 sm:w-auto sm:px-8"
      >
